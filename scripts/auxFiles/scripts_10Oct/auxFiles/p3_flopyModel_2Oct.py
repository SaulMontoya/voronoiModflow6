...
for riverIndex, riverRow in tqdm(riversDf.iterrows(), total= riversDf.shape[0]):
    ...
    else: print('Something is going on with the xInterCells')
    #yinterCells
